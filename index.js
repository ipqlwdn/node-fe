...
const UUID = process.env.UUID || '6661d892-1620-4db9-bdd1-466e21f7699f'; // 
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';       // 
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 
const NEZHA_KEY = process.env.NEZHA_KEY || '';             //             
const DOMAIN = process.env.DOMAIN || 'wofree-test.hf.space';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
...
const NAME = process.env.NAME || 'ttp';                    // 节点名称
const PORT = process.env.PORT || 8890;                     // http和ws服务端口
